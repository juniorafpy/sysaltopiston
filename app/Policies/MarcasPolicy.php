...
class MarcasPolicy
{
    ...
    {
        return $user->can('view_any_marcas');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, Marcas $marcas): bool
    {
        return $user->can('view_marcas');
    }
    ...
    {
        return $user->can('create_marcas');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, Marcas $marcas): bool
    {
        return $user->can('update_marcas');
    }
