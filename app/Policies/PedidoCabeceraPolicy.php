...
class PedidoCabeceraPolicy
{
     ...
     */
    public function view(User $user, PedidoCabecera $pedidoCabecera): bool
    {
     ...
     */
    public function update(User $user, PedidoCabecera $pedidoCabecera): bool
    {
     ...
     */
    public function delete(User $user, PedidoCabecera $pedidoCabecera): bool
    {
     ...
     */
    public function forceDelete(User $user, PedidoCabecera $pedidoCabecera): bool
    {
     ...
     */
    public function restore(User $user, PedidoCabecera $pedidoCabecera): bool
    {
     ...
     */
    public function replicate(User $user, PedidoCabecera $pedidoCabecera): bool
    {
