...
class RecepcionVehiculoPolicy
{
    ...
    {
        return $user->can('view_any_recepcion::vehiculo');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, RecepcionVehiculo $recepcionVehiculo): bool
    {
        return $user->can('view_recepcion::vehiculo');
    }
    ...
    {
        return $user->can('create_recepcion::vehiculo');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, RecepcionVehiculo $recepcionVehiculo): bool
    {
        return $user->can('update_recepcion::vehiculo');
    }
