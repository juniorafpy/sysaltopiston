...
class TipoServicioPolicy
{
    ...
    {
        return $user->can('view_any_tipo::servicio');
    }
    ...
    {
        return $user->can('view_tipo::servicio');
    }
    ...
    {
        return $user->can('create_tipo::servicio');
    }
    ...
    {
        return $user->can('update_tipo::servicio');
    }
     ...
     */
    public function replicate(User $user, TipoServicio $tipoServicio): bool
    {
